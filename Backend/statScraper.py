...
client = pymongo.MongoClient("mongodb+srv://<username>:<password>@mcmurdo.vstb3.mongodb.net/Statistics?retryWrites=true&w=majority")
db = client['stats']

# Sets up webdriver used for Selenium scraping
